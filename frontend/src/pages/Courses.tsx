...
export default function Courses({ token, onLogout, darkMode, toggleDarkMode }: CoursesProps) {
  const [courses, setCourses] = useState<Course[]>([]);
  const [form, setForm] = useState<CourseRequest>({ code: '', title: '', credits: 3, description: '' });
